...
We want to find the relationship between covid_19 and election through time. So, we select covid_19 data on March, May, July, September and November.
...
confirmed_d3 <- confirmed_d3 %>% 
  mutate(`Support Which Party` = case_when(confirmed_d3$`Biden Support Rate` > 0.5 ~ "Democratic", 
                                           confirmed_d3$`Biden Support Rate` < 0.5 ~ "Republican"
  ))
